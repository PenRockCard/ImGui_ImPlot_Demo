...
static void ShowDemoWindowsMenu();
...
int main(int, char**)
{
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Dear ImGui DirectX11 Example", WS_MAXIMIZE | WS_OVERLAPPEDWINDOW , 0, 0, 1920, 1080, NULL, NULL, wc.hInstance, NULL);
//    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Dear ImGui DirectX11 Example", WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, NULL, NULL, wc.hInstance, NULL);
    ...
    // Show the window. In the ImGui example the nCmdShow is set to SW_SHOWDEFAULT, but the SW_MAXIMIZE ensure it always fills the screen.
    ...
    // Our state
    bool show_demo_window = false; //Set to true to see ImGui Demo Stuff by default
    ...
    while (!done)
    {
        ...
        //Calls the menu bar at the top which has buttons to enable the different demos
        ShowExampleAppMainMenuBar();

        //Implot window addition
        ...
        if (show_Initial_ImGui_Window)
        {
            ...
            ImGui::Checkbox("ImGui Demo Window", &show_Main_ImGui_Window);      // Edit bools storing our window open/close state
...
static void ShowDemoWindowsMenu() {
    if (ImGui::BeginMenu("ImGui and ImPlot Demos"))
    {
